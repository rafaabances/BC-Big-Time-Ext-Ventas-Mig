page 50100 "Del Doubtful Debt Journal"
{
        ...
        area(content)
        {
            group(Control120)
            {
                ...
                field("<CurrentCurrencyCode>"; CurrentCurrencyCode)
                {
                    ...
                    trigger OnValidate()
                    begin
                        CheckCurrencyCode2(CurrentCurrencyCode);
    ...
    var
        plDoubtfulDebtJournal: Page "Del Doubtful Debt Journal";
    begin
        IF ClosingForbidden THEN BEGIN
            MESSAGE(Text51000);
            plDoubtfulDebtJournal.SetJnlBatchName(rec."Journal Batch Name");
            plDoubtfulDebtJournal.SETTABLEVIEW(Rec);
            plDoubtfulDebtJournal.SETRECORD(Rec);
            plDoubtfulDebtJournal.AllowClosing(TRUE);
            plDoubtfulDebtJournal.RUNMODAL;
        END;
    end;
    ...
    var
        ...
        Text51000: Label 'Registre las líneas del Diario. Si no, podrían aparecer incoherencias entre los datos.';
    ...
    procedure CheckCurrencyCode2(CurrencyCode: Code[10])
    var
    ...
    var
        ...
        pruebaEnum: Enum "Gen. Journal Template Type";
    begin
        IsHandled := false;
        OnBeforeSelectTemplate(Rec, GenJnlManagement, IsHandled);
        if IsHandled then
            exit;
        GenJnlManagement.TemplateSelection(PAGE::"Del Doubtful Debt Journal", pruebaEnum::Doubtful, FALSE, Rec, JnlSelected);
